...
temp <- tempfile()
download.file("https://h2o-public-test-data.s3.amazonaws.com/bigdata/laptop/mnist/train.csv.gz", temp)
train <- read.csv(unz(temp, "train.csv"))
unlink(temp)

## download test data
temp <- tempfile()
download.file("https://h2o-public-test-data.s3.namazonaws.com/bigdata/laptop/mnist/test.csv.gz",temp)
